...
import { validateFormConfig } from './validator';
...
export const aiIsAvailable = () => {
    if (OPENAI_API_KEY != null) {
        return OPENAI_API_KEY != null;
    }
}

export const getAiDrivenFormConfig = async (usersPrompt: string) => {
