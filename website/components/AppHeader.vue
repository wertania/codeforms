    ...
    >
      <div class="flex lg:flex-1">
        <a href="#" class="-m-1.5 p-1.5">
          <span class="sr-only">CodeForms.org</span>
          <img class="h-8 w-auto" src="/assets/codeforms_small.webp" alt="" />
        </a>
      </div>
...
const navigation = [
  {
    ...
    href: "https://github.com/wertania/codeforms",
  },
];
